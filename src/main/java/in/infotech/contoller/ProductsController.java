...
import in.infotech.service.CategoryService;
import in.infotech.service.ProductService;
...
public class ProductsController {
	...
	public ResponseEntity<?> deletepProducts(@PathVariable Integer id) {
		Product exists = this.ps.getProductsyById(id);
		if (exists == null) {
